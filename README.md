...
This application has been using Spring Boot as it provides a wide variety of features that aid development and maintenance. Some features that were utilized were: Spring Security, Spring Data/JPA and starters.
...
* Clone repository using following command=>  git clone https://github.com/ankitkupra/assignment.git
